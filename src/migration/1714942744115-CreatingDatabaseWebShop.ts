...
export class CreatingDatabaseWebShop1714942744115 implements MigrationInterface {
    ...
    /*         foreignKeys: [
       ...
       /*      foreignKeys: [
        ...
        await queryRunner.createTable(new Table ({
         ...
         await queryRunner.createForeignKey("product_sizes", new TableForeignKey({
            columnNames: ["product_id"],
            referencedTableName: "products",
            referencedColumnNames: ["product_id"],
            onDelete: "CASCADE"
        ...
        await queryRunner.createForeignKey("product_pictures", new TableForeignKey({
            columnNames: ["product_id"],
            referencedTableName: "products",
            referencedColumnNames: ["product_id"],
            onDelete: "CASCADE"
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropForeignKey("product_pictures", "fk_product_pictures_product_id");
    
        // Uklanjanje stranih ključeva za product_sizes
        await queryRunner.dropForeignKey("product_sizes", "fk_product_sizes_product_id");
        await queryRunner.dropForeignKey("product_sizes", "fk_product_sizes_size_id");
